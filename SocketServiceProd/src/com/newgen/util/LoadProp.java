...
public class LoadProp implements Constants {
    ...
    public static String finacleProdBpmUrl;
    public static String finacleProdFiUrl;
    ...
    static {
        try {
            ...
            //EndPoints
            finacleProdBpmUrl = properties.getProperty(FINACLEPRODBPMURL);
            finacleProdFiUrl = properties.getProperty(FINACLEPRODFIURL);
